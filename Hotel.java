...
public class Hotel{
    ...
    */
    ...
    /**
    * This variable is an array of Integers which reptresents the markedDayList for datepricemodifier
    */
    private ArrayList<Integer> markedDayList;
    /**
    * This variable is an array of Integers which reptresents the markedPriceList for datepricemodifier
    */
